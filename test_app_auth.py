...
class EventosTestCase(unittest.TestCase):
    ...
    def test_delete_manager(self):
        ...
        res = self.client().delete('/manager', json=data, headers=self.admin_token)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_delete_event(self):
        ...
        res = self.client().delete('/event', json=data, headers=self.manager_token)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['deleted']['id'], 2)
    ...
    def test_patch_event(self):
        ...
        res = self.client().patch('/event', json=data, headers=self.manager_token)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_delete_participant(self):
        ...
        res = self.client().delete('/participant', json=data, headers=self.participant_token)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['deleted']['id'], 2)
